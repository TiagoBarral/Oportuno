            ...
            <div className="flex flex-col gap-3">
              {templates.map((t) => (
                <div key={t.id} className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                  ...
                  {/* Expanded content */}
                  {expandedId === t.id && (
                    <div className="border-t border-blue-100 bg-gradient-to-br from-blue-50 to-slate-100 px-5 py-5">
                      <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="bg-white rounded-xl border border-gray-200 p-4 flex flex-col gap-3 shadow-sm">
                            ...
                            {t.contextFileName && (
                              <div>
                                <p className="text-xs font-medium text-gray-500 mb-1">Ficheiro de contexto</p>
